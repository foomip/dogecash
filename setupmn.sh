...
COIN_TGZ='https://github.com/dogecash/dogecash/releases/download/5.1.1.6/DogeCash-5.1.1.6rc99-x86_64-linux-gnu.tar.gz'
...
# unzip dogecash.zip
tar -xzf DogeCash-5.1.1.3-x86_64-linux-gnu.tar.gz
